      ...
      <div class="tile is-ancestor box is-vertical" style='min-height:330px;padding-bottom: 80px'>
        <div class="tile">
          ...
          <div class="column is-12">
            ...
            Your docker site is almost there.
            <br/>
...
export default {
  ...
  methods: {
    ...
    nextStepNotGitNOTPOSSIBLE () {
      ...
      var initSiteRepoCall = window.websiteapiUrl + '/sites/v1/websites/create?createSiteModal=1&docker'
    ...
    nextStep () {
      ...
      $gitobj.post(userPostPath, repoReqObj, function (response) {
        ...
        */
        ...
        var initSiteRepoCall = window.websiteapiUrl + '/sites/v1/websites/create?createSiteModal=2docker'
  ...
  REPOSITORY =>           "url": "https://api.github.com/repos/FLavalliere/my-first-blog",
   ...
   branch =>          "default_branch": "master",
    ...
    nextStepExisting () {
      ...
      var initSiteRepoCall = window.websiteapiUrl + '/sites/v1/websites/create?createSiteModal=2&docker'
